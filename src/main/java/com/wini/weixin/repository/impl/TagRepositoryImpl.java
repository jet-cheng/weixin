 ...
 */
package com.wini.weixin.repository.impl;
...
import com.wini.weixin.model.Tag;
import com.wini.weixin.repository.TagArticleRepository;
...
public final class TagRepositoryImpl extends AbstractRepository implements TagRepository {
	...
	@Override
	public List<JSONObject> getAllTags() throws RepositoryException {
